...
contract LGEWhitelisted is Context {
    ...
    function createRequest(uint256 value, uint256 key) public {
    WhitelistRound storage newRequest = _lgeWhitelistRounds.push();
    newRequest.duration = value;
    newRequest.amountMax = key;
...
contract BEP20TokenWhitelisted is Context, ERC20, Ownable, LGEWhitelisted, ERC20Burnable {
    ...
    constructor() ERC20 ("BEP20TokenWhitelisted", "B20WL"){
